...
export const Header = (props: HeaderProps) => {
  ...
  const { language = LanguageType.English, setLanguage } = props;
  ...
  return (
    <NavContainer>
      ...
      <ButtonsContainer>
        ...
        <MultiLingualSelect>
          <LanguageOption
            selected={language === LanguageType.English}
            onClick={() => setLanguage && setLanguage(LanguageType.English)}
          >
            English
          </LanguageOption>{" "}
          |
          <LanguageOption
            selected={language === LanguageType.Chinese}
            onClick={() => setLanguage && setLanguage(LanguageType.Chinese)}
          >
            简体中文
          </LanguageOption>
        </MultiLingualSelect>
