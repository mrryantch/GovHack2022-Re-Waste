  ...
  return (
    <FooterContainer>
      <div style={{ paddingRight: "38rem" }}>
        <CustomRow>
          <HeaderSpan style={{ paddingBottom: "4px" }}>
        ...
        <CustomRow>
          ...
          <Column>
            <ContentSpan>facebook</ContentSpan>
            <ContentSpan>twitter</ContentSpan>
            <ContentSpan>instagram</ContentSpan>
          </Column>
        </CustomRow>
        <CustomRow>
          <HeaderSpan style={{ paddingBottom: "4px" }}>CONTACT</HeaderSpan>
          <ContentSpan>+123 456 789</ContentSpan>
        </CustomRow>
      ...
      <div>
        <CustomRow>
          ...
          {showEmailMsg && (
            <span style={{ marginBottom: "10px", color: GREEN }}>
              You have successully subscribed to our latest news!
            </span>
          )}
          <PrimaryButton
            style={{ width: "120px" }}
